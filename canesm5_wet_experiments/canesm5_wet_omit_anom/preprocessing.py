...
def main():
    ...
    experiment = 'canesm5_wet_omit_anom'
    pcl = 'data/canesm5_wet_omit_anom.pickle'

    path = os.path.join(home, root, experiment, pcl)
    train = os.path.join(home, root, experiment, 'data/canesm5_wet_omit_anom_train.npy')
    valid = os.path.join(home, root, experiment, 'data/canesm5_wet_omit_anom_valid.npy')
    mask = os.path.join(home, root, experiment, 'data/canesm5_wet_omit_anom_mask.npy')
